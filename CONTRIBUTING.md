...
Thank you for your interest in contributing to Biogram! We welcome contributions of all kinds, whether you are fixing a bug, improving documentation, or proposing new features.
...
1. **Fork the repository** and clone your fork locally:
   ```bash
   git clone https://github.com/YOUR_USERNAME/biogram.git
   cd biogram
   ```
...
Biogram requires **Node.js 20+ LTS** and npm.

1. **Clone the repository and install dependencies:**
   ```bash
   git clone https://github.com/alexandrmotologa/biogram.git
   cd biogram
   npm install
   ```
